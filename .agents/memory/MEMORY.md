- [Production data writes](prod-data-writes.md) — prod DB is read-only to agent tools; dev/prod are separate DBs; do not recreate the removed bulk ticket purge route.
